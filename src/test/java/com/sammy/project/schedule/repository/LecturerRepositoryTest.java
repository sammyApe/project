...
public class LecturerRepositoryTest {
    ...
    public void lecturerRepositoryTest() {
        ...
        dayTime.setTimePreferenceList(timeList);
        ...
        lecturer.setPreferredDayTimeList(dayTimeSet);
        lecturer.setName("Name");

        lecturerRepository.save(lecturer);
        lecturerRepository.findAll().get(0).getCourseLists().iterator().next();
        Set<DayTime> s = lecturerRepository.findAll().get(0).getPreferredDayTimeList();
        s.iterator().next().getTimePreferenceList();
