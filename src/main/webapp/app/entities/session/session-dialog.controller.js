(function() {
    ...
    SessionDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Session', 'Lecturer'];

    function SessionDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Session, Lecturer) {
        var vm = this;
